...
public class GLTFUnarchiver {
    ...
    private var extractEmbeddedImages: Bool = false
    ...
    private func loadMaterial(index: Int) throws -> SCNMaterial {
        ...
        material.shaderModifiers = [
            .surface: gltf2scn_GLTFShaderModifierSurface
        ]
        #if SEEMS_TO_HAVE_DOUBLESIDED_BUG
            if material.isDoubleSided {
                material.shaderModifiers = [
                    .surface: gltf2scn_GLTFShaderModifierSurface_doubleSidedWorkaround
                ]
            }
        #endif
        ...
        case "BLEND":
            ...
            material.shaderModifiers![.surface] = gltf2scn_GLTFShaderModifierSurface_alphaModeBlend
        case "MASK":
            material.shaderModifiers![.fragment] = gltf2scn_GLTFShaderModifierFragment_alphaCutoff
        default:
