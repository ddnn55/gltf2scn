    ...
    func didLoad(by object: Any, unarchiver: GLTFUnarchiver) {
        ...
        if let specularGlossinesTexture = data.specularGlossinessTexture {
            ...
            material.shaderModifiers = [
                .surface: gltf2scn_GLTFShaderModifierSurface_pbrSpecularGlossiness_texture_doubleSidedWorkaround
            ]
        } else {
            ...
            material.shaderModifiers = [
                .surface: gltf2scn_GLTFShaderModifierSurface_pbrSpecularGlossiness
            ]
            
            #if SEEMS_TO_HAVE_DOUBLESIDED_BUG
                if material.isDoubleSided {
                    material.shaderModifiers = [
                        .surface: gltf2scn_GLTFShaderModifierSurface_pbrSpecularGlossiness_doubleSidedWorkaround
                    ]
                }
            #endif
        }
